        ...
        {showUsdbtModal && (
          <>
            ...
            >
              ...
              <button
                onClick={() => setShowUsdbtModal(false)}
                className="mt-5 w-full py-2.5 rounded-xl text-sm font-semibold text-white transition-all shadow-[inset_6px_6px_14px_rgba(255,255,255,0.12),inset_-6px_-6px_14px_rgba(255,255,255,0.12)] hover:shadow-[inset_8px_8px_20px_rgba(255,255,255,0.22),inset_-8px_-8px_20px_rgba(255,255,255,0.22)]"
